public class B4_MiltonFilter extends World
{
   ...
   public void go()
   {
      ...
      for(int row=525; row<675; row++)    //*** this is using new getBackground
      {
         for(int col=70; col<420; col++)    //*** this is using new getBackgroun
            //A nested loop since one for loop is in another
         {
            ...
            if((red>200 && green>190 && blue>0) && (red<256 && green<256 && blue<70))
            {
               plane.setPixelColor(40,67,19);
            }
            //(196,433) 196 is the column and 433 is row
         }
      }
      for(int row=270; row<317; row++)    //*** this is using new getBackground
      {
         for(int col=220; col<290; col++)    //*** this is using new getBackgroun
         //A nested loop since one for loop is in another
         {
            plane.teleport(col,row);
            ...
            if((red>0 && green>5 && blue>0) && (red<255 && green<=255 && blue<150))
            {
               plane.setPixelColor(40,67,19);
            }
            //(196,433) 196 is the column and 433 is row
      ...
      for(int row=350; row<505; row++)    //*** this is using new getBackground
      {
         for(int col=140; col<275; col++)    //*** this is using new getBackgroun
         //A nested loop since one for loop is in another
         {
            plane.teleport(col,row);
            ...
            if((red>100 && green>=0 && blue>=0) && (red<=255 && green<30 && blue<30))
            {
